          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 max-w-7xl mx-auto">
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <Bus className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
                  </div>
                  <h4 className="font-medium text-xs sm:text-sm mb-1">Selectare Locuri</h4>
                  <p className="text-xs text-muted-foreground hidden sm:block">Hărți interactive cu planuri de autocar</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/discount-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1">Sistem Reduceri</h4>
                  <p className="text-xs text-muted-foreground hidden sm:block">Atribuire reduceri per pasager</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/baggage-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1">Sistem Bagaje</h4>
                  <p className="text-xs text-muted-foreground hidden sm:block">Opțiuni bagaje cu limite și prețuri</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/payment-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-purple-200 bg-purple-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-purple-800">Sistem Plată</h4>
                  <p className="text-xs text-purple-600 hidden sm:block">Demo buy_ticket cu timer și validări</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/ticket-print-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-green-200 bg-green-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-green-800">Printare Bilete</h4>
                  <p className="text-xs text-green-600 hidden sm:block">Demo sistem printare cu link-uri multi-limbă</p>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-red-200 bg-red-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 text-white rotate-180" />
                  </div>
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-red-800">Anulare & Refund</h4>
                  <p className="text-xs text-red-600 hidden sm:block">Demo get_ticket și cancel_ticket cu estimări</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/booking-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-blue-200 bg-blue-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-blue-800">Rezervare Completă</h4>
                  <p className="text-xs text-blue-600 hidden sm:block">Demo new_order cu toate sistemele integrate</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/points-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-purple-200 bg-purple-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-purple-800">Get Points</h4>
                  <p className="text-xs text-purple-600 hidden sm:block">Demo autocomplete, țări, orașe cu caching</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/routes-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-green-200 bg-green-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-green-800">Get Routes</h4>
                  <p className="text-xs text-green-600 hidden sm:block">Demo căutare rute cu fallback XML→JSON</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/get-all-routes-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer border-indigo-200 bg-indigo-50">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-indigo-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                  </div>
                  <h4 className="font-medium text-xs sm:text-sm mb-1 text-indigo-800">Get All Routes</h4>
                  <p className="text-xs text-indigo-600 hidden sm:block">Demo orar detaliat cu stații, bagaje, politici</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/bussystem-demo">
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <h4 className="font-medium text-xs sm:text-sm mb-1">API Integration</h4>
                  <p className="text-xs text-muted-foreground hidden sm:block">Test complet Bussystem endpoints</p>
                </CardContent>
              </Card>
            </Link>
          </div>
